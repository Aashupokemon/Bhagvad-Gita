            ...
            <div className="home-grid">
                    ...
                    {chapters.map((ch) => (
                      ...
                      >
                        ...
                        <div className="card-bottom">
                          <Clock3 size={14} /> 4 min <span /> 1 lesson + quiz
                        </div>
                      </button>
                    ))}
                  </div>
              ...
              <aside className="wisdom-column">
                <section className="shloka-card">
                  ...
                  <p>
                    A simple learning takeaway: care about your effort without
                    letting the result define you.
                  </p>
                ...
                <section className="journey-card">
                  ...
                  <p>
                    Every chapter is a chance to bring a little more wisdom into
                    your day.
                  </p>
          ...
          <>
            ...
            <div className="lesson-layout">
              <section className="lesson-surface">
                <Tabs value={stage} onValueChange={(v) => setStage(String(v))}>
                    ...
                    >
                      {c.options.map((option, i) => (
                        ...
                        >
                          ...
                          {option}
                          {checked && i === c.correct && <Check size={18} />}
                        </label>
                      ))}
                    </RadioGroup>
                    {checked ? (
              ...
              <aside className="verse-panel">
                ...
                <small>
                  Simplified educational interpretation. Everyday stories are
                  modern illustrations, not events from the scripture.
